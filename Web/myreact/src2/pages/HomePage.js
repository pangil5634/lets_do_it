                ...
                <FieldSet width="90%" fontSize="20px">
                    ...
                    <Div justifyContent="space-between">
                        <Div flexDirection="column">
                            <Img src={require('../image/PL/html.png')} alt="html" blur={true}/>
                            <Label color="black">html</Label>
                        </Div>
                        <Div flexDirection="column">
                            <Img src={require('../image/PL/css.png')} alt="css" blur={true}/>
                            <Label color="black">css</Label>
                        </Div>
                        <Div flexDirection="column">
                            <Img src={require('../image/PL/javascript.png')} alt="js" blur={true}/>
                            <Label color="black">javascript</Label>
                        </Div>
                        <Div flexDirection="column">
                            <Img src={require('../image/PL/java.png')} alt="java" blur={true}/>
                            <Label color="black">java</Label>
                        </Div>
                        <Div flexDirection="column">
                            <Img src={require('../image/PL/git.png')} alt="git" blur={true}/>
